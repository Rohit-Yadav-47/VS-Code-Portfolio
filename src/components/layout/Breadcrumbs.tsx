...
const Breadcrumbs: React.FC<BreadcrumbsProps> = ({ activeSection }) => {
  return (
    <div className="bg-[#1e1e1e] px-4 py-1.5 z-10 flex items-center gap-1 text-xs text-gray-400">
      ...
      <span className="text-gray-300 hover:bg-[#2a2a2a] px-1 py-0.5 rounded cursor-pointer">components</span>
      <ChevronRight className="w-3 h-3 text-gray-500" />
      <span className="text-gray-300 hover:bg-[#2a2a2a] px-1 py-0.5 rounded cursor-pointer">content</span>
      <ChevronRight className="w-3 h-3 text-gray-500" />
